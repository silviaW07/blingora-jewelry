...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      // Seeded product/category/avatar images are served from these hosts
      { protocol: 'https', hostname: '**.autocoder.cc', pathname: '/**' },
      { protocol: 'https', hostname: 'autocoder.cc', pathname: '/**' },
      { protocol: 'https', hostname: '**.koudingyip.com', pathname: '/**' },
      { protocol: 'https', hostname: '**.koudingvip.com', pathname: '/**' },
      { protocol: 'https', hostname: 'static.nike.com.cn', pathname: '/**' },
