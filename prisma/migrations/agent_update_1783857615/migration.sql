...
-- AlterTable
ALTER TABLE `keywordgroup` ADD COLUMN `sceneKey` VARCHAR(160) NULL,
    ADD COLUMN `sceneType` VARCHAR(80) NULL;

-- CreateIndex
CREATE INDEX `keywordgroup_sceneKey_idx` ON `keywordgroup`(`sceneKey`);

-- CreateIndex
CREATE INDEX `keywordgroup_sceneType_idx` ON `keywordgroup`(`sceneType`);
