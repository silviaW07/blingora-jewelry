...
CREATE TABLE `product_category_relations` (
    ...
    INDEX `product_category_relations_productId_idx`(`productId`),
    INDEX `product_category_relations_categoryId_idx`(`categoryId`),
    UNIQUE INDEX `product_category_relations_productId_categoryId_key`(`productId`, `categoryId`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `product_keyword_relations` (
    ...
    INDEX `product_keyword_relations_productId_idx`(`productId`),
    INDEX `product_keyword_relations_keywordId_idx`(`keywordId`),
    UNIQUE INDEX `product_keyword_relations_productId_keywordId_key`(`productId`, `keywordId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `product_category_relations` ADD CONSTRAINT `product_category_relations_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `product`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_category_relations` ADD CONSTRAINT `product_category_relations_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `category`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_keyword_relations` ADD CONSTRAINT `product_keyword_relations_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `product`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_keyword_relations` ADD CONSTRAINT `product_keyword_relations_keywordId_fkey` FOREIGN KEY (`keywordId`) REFERENCES `keyworditem`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
