...
-- AlterTable
ALTER TABLE `keywordgroup` ADD COLUMN `sceneArea` ENUM('LEFT_NAV', 'RECOMMENDATION', 'BOTH') NOT NULL DEFAULT 'RECOMMENDATION';

-- CreateTable
CREATE TABLE `categorynavconfig` (
    `id` VARCHAR(36) NOT NULL,
    `categoryId` VARCHAR(36) NOT NULL,
    `navTitle` VARCHAR(120) NULL,
    ...
    INDEX `categorynavconfig_isVisible_idx`(`isVisible`),
    INDEX `categorynavconfig_sortWeight_idx`(`sortWeight`),
    UNIQUE INDEX `categorynavconfig_categoryId_key`(`categoryId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateIndex
CREATE INDEX `keywordgroup_sceneArea_idx` ON `keywordgroup`(`sceneArea`);
